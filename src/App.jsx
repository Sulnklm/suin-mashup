    ...
    <Header />
      <main>
          <div className="flex items-center justify-center overflow-hidden relative w-full  aspect-[4.78/2] lg:aspect-[4.78/2] video">
             <iframe className="object-cover absolute left-0 w-full h-full border-0 top-[-60px] translate-y-14" src="https://www.youtube.com/embed/LEjhY15eCx0?si=Nbw-uIrLIKeUluyL&controls=0&showinfo=0&autoplay=1&mute=1&loop=1&playlist=LEjhY15eCx0" title="YouTube video player"></iframe>
          </div>
